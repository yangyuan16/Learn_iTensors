...
let 
    ...
    maxdim = [200]
    bc = "ob"
    loadpath = "./chain-Heisenberg/output/psi/"
    ...
    savepath = "./chain-Heisenberg/output/obs/magz/"
    ...
    savepath = "./chain-Heisenberg/output/obs/magx/"
    filename_magx_1 = "1dchain_N$(N)_S1_maxdim$(last(maxdim))_"
    filename_magx_2 = bc
    ...
    savepath = "./chain-Heisenberg/output/obs/corr_z/"
    filename_corr_z_1 = "1dchain_N$(N)_S1_maxdim$(last(maxdim))_"
    ...
    savepath = "./chain-Heisenberg/output/obs/corr_spsm/"
    filename_corr_spsm_1 = "1dchain_N$(N)_S1_maxdim$(last(maxdim))_"
    ...
    savepath = "./chain-Heisenberg/output/obs/corr_smsp/"
    filename_corr_smsp_1 = "1dchain_N$(N)_S1_maxdim$(last(maxdim))_"
    ...
    for b = 2:N-1
        ...
        savepath = "./chain-Heisenberg/output/obs/e_spectrum/"
        filename_e_spectrum_1 = "1dchain_N$(N)_S1_maxdim$(last(maxdim))_"
    ...
    # save entropy
    savepath = "./chain-Heisenberg/output/obs/entropy/"
    filename_entropy_1 = "1dchain_N$(N)_S1_maxdim$(last(maxdim))_"
